...
@Component({
  selector: 'app-death-disability',
  templateUrl: './death-disability.component.html',
  styleUrls: ['./death-disability.component.scss']
})
export class DeathDisabilityComponent implements OnInit {
