...
@Component({
  selector: 'app-settlement-certificate-details',
  templateUrl: './settlement-certificate-details.component.html',
  styleUrls: ['./settlement-certificate-details.component.scss']
})


export class SettlementCertificateDetailsComponent implements OnInit {
    ...
    if (localStorage.getItem('AppLabels') != null) {
      ...
      for (let labels of this.AppFormLabels) {
        ...
        if (labels.formID == this.formId && labels.language == this.languageType) {
          ...
          index++;
          if(index === 1) {
            this.formHeaderLabels.push({ "headerName": "Settlement Certificate", "formID": "EmployeeCertificate", "subHeaderName": "شهادة التسوية", "status": "Active"})
